...
public class CampaignSessionRegistry {
    ...
    /** Активные кампании игроков: playerName → CampaignEntity */
    private final Map<String, CampaignEntity> campaigns = new ConcurrentHashMap<>();
     ...
     *
     * @param playerName имя игрока
     * @param campaignEntity   объект кампании
     */
    public void putCampaign(String playerName, CampaignEntity campaignEntity) {
        campaigns.put(playerName, campaignEntity);
    }
     ...
     *
     * @param playerName имя игрока
     * @return объект CampaignEntity или null, если нет
     */
    public CampaignEntity getCampaign(String playerName) {
